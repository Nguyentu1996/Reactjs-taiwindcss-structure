...
function Header() {
    ...
    return <div className="flex bg-default z-40">
        <div className="container mx-auto pt-1">
            <div className="h-15 sm:h-10 flex flex-wrap content-center">
                <div id="nav-left" className="text-gray-50 flex content-center self-center pl-2 h-5/6 w-4/12 xl:w-2/12 md:w-3/12 sm:w-3/12">
                    <a href="/" className="flex self-center text-lg cursor-pointer whitespace-nowrap px-10 xl:px-0 md:px-0 sm:px-0">
                        React & TailwindCss
                </a>
                </div>
                ...
                <div className="flex w-full flex-row xl:w-10/12 md:w-9/12 sm:w-9/12">
                    ...
                    <div id="nav-right" className="text-gray-50 flex justify-center self-center cursor-pointer w-4/12 xl:w-3/12 md:w-4/12 sm:w-4/12">
                        ...
                        <div className="flex self-center absolute top-0 right-0 sm:static flex justify-end self-center ">
                            ...
                            <p className="mt-2 mx-2 text-sm hover:text-yellow-300">Login</p>
                        </div>
                    </div>
                </div>
